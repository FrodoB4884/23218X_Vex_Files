...
# |	Project:      GeorgeDrive                       |
# |	Team:         23218X                            |
# |	Description:  George's Drivetrain configuration |
# |                                                 |
# |-------------------------------------------------|
...
def data_logging():
    ...
    while True:
        ...
        #objects = ai_vision_sensor.take_snapshot(AiVision.ALL_AIOBJS)
        #data = (left_drive_smart.temperature(), right_drive_smart.temperature, x, y, inertial_sensor.heading, limit_sensor.pressing(), objects)
        wait(50, MSEC)
